...
#define LM_NAME_MODEL(name, from)                                                   \
  ...
  public:                                                                           \
    ...
    typedef detail::GenericModel<trie::TrieSearch<DontQuantize LM_COMMA() trie::DontBhiksha> LM_COMMA() SortedVocabulary> SomeModel;
...
// ::std::unique_ptr<::std::string> LoadSome(const ::std::string &file_name);